...
namespace FlightManager.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(FlightManagerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Password,Email,FirstName,LastName,EGN,Adress,PhoneNumber,Role")] User user)
        {
