...
namespace FlightManager.Controllers
{
    public class PassengersController : Controller
    {
        ...
        public PassengersController(FlightManagerContext context)
        {
            _context = context;
        }
        ...
        {
            var flightManagerContext = _context.Passengers.Include(p => p.Flight);
            return View(await flightManagerContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,MiddleName,LastName,EGN,PhoneNumber,Nationality,TicketType,FlightID")] Passenger passenger)
        {
